...
import demo.img.app.R.id.list_item_caption
import demo.img.app.R.id.list_item_thumbnail
import demo.img.app.databinding.ViewThumbnailBinding
import demo.img.app.databinding.ViewThumbnailBinding.bind
import demo.img.app.databinding.ViewThumbnailBinding.inflate
import demo.img.app.widget.SquareFrameLayout
...
internal class ListAdapterTest {
    ...
    private val adapter = ListAdapter(picasso)

    private val view = mockk<SquareFrameLayout> {
